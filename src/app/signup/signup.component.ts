...
export class SignupComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let password = new FormControl('', [Validators.required, Validators.maxLength(genralConfig.pattern.PASSWORDMAXLENGTH), Validators.minLength(genralConfig.pattern.PASSWORDMINLENGTH)]);
