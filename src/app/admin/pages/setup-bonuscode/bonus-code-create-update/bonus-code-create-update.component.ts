...
export class BonusCodeCreateUpdateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.form = this.fb.group({
      bonusCode: [this.defaults.bonusCode || '', [Validators.required, Validators.maxLength(genralConfig.pattern.NAMEMAXLENGTH), Validators.minLength(genralConfig.pattern.NAMEMINLENGTH)]],
      
      discount_off: [this.defaults.discount_off || '', [Validators.required, Validators.maxLength(genralConfig.pattern.NAMEMAXLENGTH), Validators.minLength(genralConfig.pattern.NAMEMINLENGTH)]]
    })
  }
  ...
  createBonuSode() {
    ...
    console.log('This bonus code is ===========>', bonusCode);
